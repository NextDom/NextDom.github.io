			...
			<div class="card small hoverable sticky-action">\
				<span class="card-title center-align">'+_data.third_plugin.docs[i].name+'</span>\
					<div class="card-text">\
						...
						[![Waffle.io - Columns and their card count](https://badge.waffle.io/Jeedom-Plugins-Extra/plugin-'+_data.third_plugin.docs[i].name+'.svg?columns=all)](https://waffle.io/Jeedom-Plugins-Extra/plugin-'+_data.third_plugin.docs[i].name+')
					</div>\
